...
export function IconAiAgent({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      {/* Hexagonal head */}
      <path
        d="M12 2L19.5 6.5V14.5L12 19L4.5 14.5V6.5L12 2Z"
        stroke="currentColor"
        strokeWidth="1.4"
      ...
      <path
        d="M9 15.2H12M15 15.2H12M12 15.2V16.5"
        stroke="currentColor"
        strokeWidth="1.1"
        strokeLinecap="round"
      />
...
export function IconLlmNlp({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      {/* Text input lines */}
      <rect x="2" y="3" width="20" height="3.5" rx="1.75" stroke="currentColor" strokeWidth="1.4" />
      {/* Token blocks */}
      <rect x="2" y="9" width="5.5" height="3" rx="1" stroke="currentColor" strokeWidth="1.3" />
      <rect x="9.25" y="9" width="5.5" height="3" rx="1" stroke="currentColor" strokeWidth="1.3" />
      <rect x="16.5" y="9" width="5.5" height="3" rx="1" stroke="currentColor" strokeWidth="1.3" />
      {/* Attention arrows */}
      ...
      <path
        d="M4.75 14.5 Q12 13.5 19.25 14.5"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
        fill="none"
...
export function IconDevOps({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      ...
      <path
        d="M8.5 12C8.5 12 6 8 3.5 8C1 8 1 12 3.5 12C6 12 8.5 8 11 8H13C15.5 8 18 12 20.5 12C23 12 23 8 20.5 8C18 8 15.5 12 13 12H11C8.5 12 6 16 3.5 16C1 16 1 12 3.5 12"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        fill="none"
...
export function IconDevSecOps({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      {/* Shield */}
      <path
        d="M12 2.5L20 6V12C20 16.4 16.4 20.3 12 21.5C7.6 20.3 4 16.4 4 12V6L12 2.5Z"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinejoin="round"
      />
...
export function IconInfrastructure({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      {/* Server rack units */}
      <rect x="3" y="3.5" width="18" height="4" rx="1" stroke="currentColor" strokeWidth="1.4" />
      <rect x="3" y="10" width="18" height="4" rx="1" stroke="currentColor" strokeWidth="1.4" />
      <rect x="3" y="16.5" width="18" height="4" rx="1" stroke="currentColor" strokeWidth="1.4" />
      {/* Status dots row 1 */}
